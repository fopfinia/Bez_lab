...
x1, y1 = np.loadtxt('week11/01.txt', unpack=True, dtype=int)
x2, y2 = np.loadtxt('week11/02.txt', unpack=True, dtype=int)
x3, y3 = np.loadtxt('week11/03.txt', unpack=True, dtype=int)
